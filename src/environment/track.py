...
class Track:
    def __init__(self, track_name: str = "default_oval", track_width: float = 1.6) -> None:
        ...
        if track_name == "s_curve":
            self.waypoints = [
                (0.0, 0.0), (3.0, 0.0), (6.0, 0.0), (8.5, 1.0),
                (9.5, 3.0), (8.5, 5.0), (6.0, 6.0), (3.5, 6.5),
                (2.0, 8.0), (2.0, 10.0), (3.5, 11.5), (6.0, 12.0),
                (8.5, 11.5), (10.0, 9.5), (11.5, 6.5), (11.5, 2.0),
                (9.5, -2.0), (6.0, -3.5), (2.0, -3.5), (-1.5, -2.0),
                (-2.0, -0.5)
            ]
